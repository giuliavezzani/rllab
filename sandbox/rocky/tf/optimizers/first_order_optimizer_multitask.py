...
class FirstOrderOptimizerMultiTask(Serializable):
    """
    ...
    def __init__(
        ...
        #self._tf_optimizer = tf_optimizer_cls()
    ...
    def loss(self, inputs, extra_inputs=None):
        ...
        return self._opt_fun["f_loss"](*(tuple(inputs[0] + inputs[1]) + extra_inputs))

    def optimize(self, inputs, extra_inputs=None, callback=None, batch_size=32):
        ...
        last_loss = f_loss(*(tuple(inputs[0] + inputs[1]) + extra_inputs))

        start_time = time.time()


        dataset = BatchDataset(inputs[0] + inputs[1], batch_size, extra_inputs=extra_inputs)
        ...
        for epoch in range(self._max_epochs):
            ...
            new_loss = f_loss(*(tuple(inputs[0] + inputs[1]) + extra_inputs))
